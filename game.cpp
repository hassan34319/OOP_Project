...
void AirHockey::calcGameState()
{
	...
	{
		puck.yCurrPos = (puck.yCurrPos > puckMaxY ? puckMaxY * 2 - puck.yCurrPos : borderWidth - puck.yCurrPos);		//calculation of the � coordinate after the collision with the field boundary
		puck.ySpeed *= -1;
		mGameUI->playClashSound(eClash_Board);
